...
// ✨ 경로 오류의 주범이었던 외부 import를 지우고, 컴포넌트 전용 규격을 만들었습니다.
...
export default function VideoItem({ video, idx }: VideoProps) {
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <div className="relative overflow-hidden group w-full aspect-[9/16] bg-black rounded-3xl shadow-2xl">
        <video 
          ref={videoRef}
          controls={isPlaying} 
          preload="metadata" 
        ...
        {!isPlaying && (
          ...
          >
            ...
            <div className="absolute inset-0 flex items-center justify-center bg-black/10 transition-all group-hover:bg-black/30">
              <div className="flex items-center justify-center w-16 h-16 bg-white/20 backdrop-blur-md border border-white/30 rounded-full shadow-xl">
